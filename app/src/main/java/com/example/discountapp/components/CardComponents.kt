...
fun MainCard(title: String, number: Double, modifier: Modifier = Modifier) {
    Card(
        ...
        Column(
            ...
            Text(text = title, color = Color.Black, fontSize = 20.sp, textAlign = TextAlign.Center)
            Text(text = "$${number}", color = Color.Black, fontSize = 20.sp, textAlign = TextAlign.Center)
        }
    }
}